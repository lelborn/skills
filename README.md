...
- **[keep-a-changelog](skills/keep-a-changelog/SKILL.md)** — Write, update, and review a `CHANGELOG.md` following [Keep a Changelog 1.1.0](https://keepachangelog.com/en/1.1.0/). Covers the six change types, cutting releases, turning commits into entries, yanked releases, and compliance audits.
...
- **[github-workflow](skills/github-workflow/SKILL.md)** — Govern every GitHub-touching action before it runs: account resolution, issues, projects, milestones, branches, PRs, releases, and dependabot, with pre/post-work gates so nothing lands on the wrong account or without tracking.
